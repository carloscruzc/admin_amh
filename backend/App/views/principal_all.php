                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="d-flex flex-column h-100">
                                            <h4 class="m-4">¡Bienvenido a tu administrador equipo GRUPO LAHE!<br><strong>CONGRESO AMH 2022</strong></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <a href="/Estadisticas/">
                                        <div class="card up-card">
                                            <div class="row m-4">
                                                <div class="col-3">
                                                    <div class="bg-gradient-pink avatar avatar-l position-relative" >
                                                        <span class="fas fa-chart-bar m-3 text-white" style="font-size: x-large;"></span>
                                                    </div>
                                                </div>
                                                <div class="col-9 m-auto">
                                                    <div class="col-auto my-auto">
